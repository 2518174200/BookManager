    ...
    <div id="container">
    	...
    	<div id="main">
			<div class="section-left">    	
				...
				<table class="table" cellspacing="0" style="font-size: 12px;">
			    	...
			    	<c:forEach items="${pg.pageLists }" var="b">
			    		<tr>
				    		<td>${b.bookName }${b.id}</td>
				    		<td>${b.author }</td>
				    		<td>${b.bookCategory.category}</td>
				    		<td>￥<fmt:formatNumber value="${b.price }" pattern="0.00"/> </td>
				    		<td><a href="${pageContext.request.contextPath}/admin?id=${b.id}&&op=delete ">删除</a>&nbsp;<a href="${pageContext.request.contextPath}/admin?op=findid&&id=${b.id}">编辑</a></td>
				    	</tr>
			    	</c:forEach>
			    </table>
			    <div class="paging">
			...
			<div class="section-right">
				<h2>添加图书信息</h2>
				<form action="${pageContext.request.contextPath}/admin?op=add1" method="post">
