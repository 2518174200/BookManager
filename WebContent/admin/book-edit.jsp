    ...
    <div id="container">
    	...
    	<div id="main">
			<div class="section-left">    	
				...
				<form action="${pageContext.request.contextPath}/admin?op=update" method="post">
					<input type="hidden" name="bookId" value="1" />
					<input type="hidden" name="bphotoOld" value="fzdxl.jpg" />
					<p>图书书名：<input type="text" name="bookName" value="${find.bookName }"  /></p>
					<p>图书作者：<input type="text" name="author" value="${find.author }"  /></p>
					<p>图书分类：
					...
					<p>图书售价：<input type="text" name="price" value="${find.price }" /></p>
					<p>图书出版社：<input type="text" name="publisher" value="${find.publisher }"  /></p>  
					<p>当前图片：<img width="150" height="90" src="${pageContext.request.contextPath}/static/photo/fzdxl.jpg" /></p> 
					<p>图书图片：<input type="file" name="photo"  value="${find.photo }"/></p>    				 				
